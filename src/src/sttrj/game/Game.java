...
public class Game {
    ...
    public Game(InputHandler input, View view, Enterprise enterprise, Galaxy galaxy) {
        ...
        Quadrant start = this.galaxy.quadrantAt(4, 4);
        //if the starting quadrant is null, create a new one
        if (start == null) {
            start = new Quadrant(4, 4);
        }
        //set the current Quadrant to the starting quadrant
        this.currentQuadrant = start;
    ...
    public void phasers(int energy, Quadrant quadrant) {
        ...
        //cleanup the Klingons in the quadrant
        quadrant.cleanup();
    ...
    */
    public int parseWarpCoordsForCourse(final String coords) {
        //parse the course from the first character (validator ensures this is valid)
        int course = Integer.parseInt(String.valueOf(coords.charAt(0)));
        return course;
    }
    ...
    */
    public void moveBetweenQuadrants(final int course, final double distance) {
        ...
        */
        //get the x and y of the current quadrant
        int quadrantX = this.currentQuadrant.getX();
        int quadrantY = this.currentQuadrant.getY();
        //get the number of stars and starbases in the current quadrant
        ...
        //recreate the quadrant preserving entity counts, randomising positions
        ...
        //set the Enterprise's position to the new position
